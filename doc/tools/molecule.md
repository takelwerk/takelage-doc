...
molecule resides in directories named *molecule* which can be found
...
Each molecule scenario is configured by a *molecule.yml*
...
the 
[scenario sequences](https://molecule.readthedocs.io/en/latest/configuration.html#scenario)
